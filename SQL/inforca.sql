...
-- Export de données de la table inforca.banners : ~5 rows (environ)
...
-- Export de données de la table inforca.banner_zone : ~11 rows (environ)
...
-- Export de données de la table inforca.contacts : ~15 rows (environ)
...
-- Export de données de la table inforca.dealers : ~3 rows (environ)
...
-- Export de données de la table inforca.manufacturers : ~7 rows (environ)
...
-- Export de données de la table inforca.migrations : ~19 rows (environ)
...
-- Export de données de la table inforca.news : ~0 rows (environ)
...
-- Export de données de la table inforca.partners : ~1 rows (environ)
...
-- Export de données de la table inforca.password_resets : ~0 rows (environ)
...
-- Export de données de la table inforca.products : ~0 rows (environ)
...
-- Export de données de la table inforca.zones : ~0 rows (environ)
