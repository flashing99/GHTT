...
-- Export de données de la table ghtt.bookings : 1 rows
/*!40000 ALTER TABLE `bookings` DISABLE KEYS */;
INSERT INTO `bookings` (`id`, `lastname`, `firstname`, `mobile`, `state`, `created_at`, `updated_at`) VALUES
	(1, 'nom1', 'prenom1', '0550447788', '1', '2021-04-13 09:23:33', '2021-04-13 09:23:35');
/*!40000 ALTER TABLE `bookings` ENABLE KEYS */;

-- Export de la structure de la table ghtt. booking_details
CREATE TABLE IF NOT EXISTS `booking_details` (
  ...
  `Colonne 7` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Export de données de la table ghtt.booking_details : ~1 rows (environ)
/*!40000 ALTER TABLE `booking_details` DISABLE KEYS */;
INSERT INTO `booking_details` (`id`, `booking_id`, `adult`, `children`, `housing_id`, `housing_name`, `number`, `Colonne 7`, `amount`, `vat`, `date_start`, `date_end`, `state`, `created_at`, `updated_at`) VALUES
	(1, 1, 2, 0, 28, 'F4', 'F446', '', 1500.00, 17, '2021-04-10', '2021-04-13', '1', '2021-04-10 14:59:19', NULL);
...
INSERT INTO `housings` (`id`, `name`, `number`, `area`, `floor`, `online`, `vip`, `description`, `subcategory_housing_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'F4', 'F449', 'ZONE-E La PinÃ©de', NULL, 1, 0, ' ', 4, '2021-04-12 10:50:54', '2021-04-13 07:36:57', NULL),
	...
	(144, 'D2', 'D231', 'ZONE-C', NULL, 0, 0, ' ', 2, '2021-04-12 10:50:54', '2021-04-12 13:08:48', NULL),
...
-- Export de données de la table ghtt.migrations : ~7 rows (environ)
