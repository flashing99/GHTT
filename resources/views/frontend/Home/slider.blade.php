    ...
    <div id="slider-revolution">
        <ul>
            <li data-transition="fade">
                <img src="{{ asset('./assets/images/slider/img-1.jpg')}}" data-bgposition="left center"
            ...
            <li data-transition="fade">
                ...
                <div class="tp-caption sfb fadeout slider-caption-sub slider-caption-sub-3" data-x="center" data-y="365"
                     data-easing="easeOutBack" data-speed="700" data-start="2200">JUST LIKE YOU
                </div>

                <div class="tp-caption sfb fadeout slider-caption-sub slider-caption-sub-3" data-x="center" data-y="395"
                     data-easing="easeOutBack" data-speed="700" data-start="2400"><img src="{{ asset('./assets/images/icon-slider-2.png')}}"
                                                                                       alt=""></div>
            </li>
...
{{--<section class="section-slider">
    ...
    <div id="slider-revolution">
        <ul>
            <li data-transition="fade">
                <img src="./assets/images/slider/img-5.jpg" data-bgposition="left center" data-duration="14000"
                     data-bgpositionend="right center" alt="">

                <div class="tp-caption sft fadeout slider-caption-sub slider-caption-1" data-x="center" data-y="100"
                     data-speed="700" data-start="1500" data-easing="easeOutBack">
                    <img src="./assets/images/slider/hom1-slide1.png" alt="icons">
                </div>
            ...
            <li data-transition="fade">
                <img src="./assets/images/slider/img-4.jpg" data-bgposition="left center" data-duration="14000"
                     data-bgpositionend="right center" alt="">
                ...
                <div class="tp-caption sfb fadeout slider-caption-sub slider-caption-sub-3" data-x="center" data-y="395"
                     data-easing="easeOutBack" data-speed="700" data-start="2400"><img src="./assets/images/icon-slider-2.png"
                                                                                       alt=""></div>
            </li>
...
<section class="section-slider slider-style-2 clearfix">
    ...
    <div id="slider-revolution">
        <ul>
            <li data-transition="fade">
                <img src="{{ asset('./assets/images/slider/slide-3.jpg')}}" data-bgposition="left center" data-duration="14000"
                     data-bgpositionend="right center" alt="">
                ...
                <div class="tp-caption sfb fadeout slider-caption-sub slider-caption-sub-3" data-x="center"
                     data-y="395" data-easing="easeOutBack" data-speed="700" data-start="2400"><img
                        src="{{ asset('./assets/images/icon-slider-2.png')}}" alt=""></div>
            </li>

            <li data-transition="fade">
                <img src="{{ asset('./assets/images/slider/slider-1.png')}}" data-bgposition="left center" data-duration="14000"
                     data-bgpositionend="right center" alt="">
            ...
            <li data-transition="fade">
                <img src="{{ asset('./assets/images/slider/img-4.jpg')}}" data-bgposition="left center" data-duration="14000"
                     data-bgpositionend="right center" alt="">
