...
<section class="_section-slider _slider-style-2 clearfix">
    <h1 class="element-invisible">Slider</h1>
    <div class="slider">
        <div id="rev-slider-1" class="rev_slider gradient-slider" style="display:none" data-version="5.4.5">
            <ul>
                <li data-transition="crossfade">
                    <img src="{{ asset('./assets/images/slider/slide-1.png')}}" data-bgposition="left center"
                         data-duration="14000"
                    ...
                    <div class="tp-caption sft fadeout slider-caption-sub slider-caption-sub-3"
                         data-x="center"
                         data-y="220"
                         data-speed="700"
                         data-start="1500"
                    ...
                    <div class="tp-caption sfb fadeout slider-caption slider-caption-3 f36 f-600 "
                         data-x="center"
                         data-y="280"
                         data-speed="700"
                         data-easing="easeOutBack"
                    ...
                    <div class="tp-caption sfb fadeout slider-caption-sub slider-caption-sub-3"
                         data-x="center"
                         data-y="365"
                         data-speed="700"
                         data-easing="easeOutBack"
                         data-start="2200">EN CŒUR DE VILLE
                        HISTORIQUE
                    </div>
                    ...
                    <div class="tp-caption sfb fadeout slider-caption-sub slider-caption-sub-3"
                         ...
                         data-start="2400"
                    >
                        <img src="{{ asset('./assets/images/icon-slider-2.png')}}" alt=""></div>
                </li>

                <li data-transition="crossfade">
                    <img src="{{ asset('./assets/images/slider/slider-1.png')}}"
                    ...
                    <div class="tp-caption sft fadeout slider-caption-sub slider-caption-1"
                         data-x="center"
                         data-y="100"
                         data-speed="700"
                         data-start="1500"
                    ...
                    >
                        ...
                        <img src="{{ asset('./assets/images/footer/ghtt-w.png')}}" alt="icons">
                    </div>
                    ...
                    <div class="tp-caption sfb fadeout slider-caption slider-caption-sub-1"
                         data-x="center"
                         data-y="280"
                         data-speed="700"
                         data-easing="easeOutBack"
                    ...
                    <a href="#" class="tp-caption sfb fadeout awe-btn awe-btn-12 awe-btn-slider"
                       data-x="center"
                       data-y="380"
                       data-easing="easeOutBack"
                       data-speed="700"
                ...
                <li data-transition="crossfade">
                    <img src="{{ asset('./assets/images/slider/img-4.jpg')}}"
                         data-bgposition="left center"
                         data-duration="14000"
                         data-bgpositionend="right center"
                         alt=""
