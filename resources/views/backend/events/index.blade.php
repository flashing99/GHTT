...
@section('header_page_title', 'Gestion des evènements')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Gestion des évènements</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            ...
            <div class="row p-b-md">
                <div class="col-lg-12 p-l-none">
                    <a href="{{ route('events.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Ajouter un nouveau évènement</a>
                </div>
            </div>
    ...
    $(document).ready( function () {
       ...
       /* When click edit user */
        $('body').on('click', '.edit-article', function () {
            ...
            window.location.href = SITEURL + "/backoffice/events/"+event_id+"/edit";
       });
        ...
        $('body').on('click', '#delete-article', function () {
            ...
            swal({
                ...
                $.ajax({
                    type: "DELETE",
                    url: SITEURL + "/Backoffice/events/"+event_id,
        ...
        $('body').on('click', '.etat', function () {
            var elem            = $(this),
                event_id        = elem.attr('data-id'),
                slider_status    = elem.attr('data-status');

            $.ajax({ 
            headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
            type: "POST",
            url: SITEURL + "/Backoffice/events/ajax/"+event_id+'/status',
