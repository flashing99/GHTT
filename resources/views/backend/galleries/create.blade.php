                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                ...
                                <select id="type" name="type"
                                        class="type form-control @error('type') is-invalid @enderror" required>
                                    <option></option>
                        ...
                        <div id="type_image">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <input id="image_gallerie" type="file" hidden="hidden"
                                           class="form-control @error('image_gallerie') is-invalid @enderror"
                                           name="image_gallerie">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input id="url" type="text" class="form-control @error('url') is-invalid @enderror"
                                           name="url" placeholder="Veuillez introduire l'URL de la video YouTube">
                        ...
                        {{--
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    ...
                                                    <select id="categorie" name="categorie[]"  multiple="multiple" class="categorie form-control @error('categorie') is-invalid @enderror" required>
                                                        <option></option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                ...
                                <select id="categorie" name="categorie"
                                        class="categorie form-control @error('categorie') is-invalid @enderror"
                                        required>
                                    <option></option>
                                    @foreach ($categories as $categorie)
                                        <option value="{{ $categorie->id }}">{{ $categorie->name }}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input id="titre" type="text" class="form-control @error('titre') is-invalid @enderror"
                                       ...
                                       placeholder="Veuillez introduire le titre">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                ...
                                <textarea id="description"
                                          ...
                                          placeholder="Veuillez introduire la description">{{ old('description') }}</textarea>
