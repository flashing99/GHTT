...
Route::namespace('Galleries')->middleware('can:manage-galleries')->group(function(){
    ...
    Route::get('/galleries/images/{filename}', 'GallerieController@displayImage')->name('galleries.displayImage');
    Route::get('/galleries/images/thumbnail/{filename}', 'GallerieController@displayThumbnailImage')->name('galleries.displayThumbnailImage');
